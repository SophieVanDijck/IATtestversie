	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Actief', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Rust', //Will appear in the data and in the default feedback message.
				title : {
			...
			base_url : {//Where are your images at?
				image : 'https://https://sophievandijck.github.io/IATimages'
			},
			...
			leftKeyText : 'Druk op de "E" voor', 
			rightKeyText : 'Druk op de "I" voor', 
			...
			finalText : 'Zodra je klaar bent, druk je op de spatie-toets om verder te gaan', 
			finalTouchText : 'Klik op de onderste groene toets om verder te gaan.',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Zet je linkervinger op de <b>E</b> toets voor items die toebehoren tot de categorie <font color="#0000ff">leftAttribute.</font>.' +
				'<br/>Zet je rechtervinger op de <b>I</b> toets voor items die toebehoren tot de categorie <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. ' +
				'Corrigeer je fout door de andere toets in te tikken.<br/>' +
				'<u>Ga zo snel als je kan</u> en zo min mogelijk fouten te maken.<br/><br/></p>'+
				'<p align="center">Druk op de <b>spatie toets</b> wanneer je klaar bent.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Zet je linkervinger op de <b>linker</b> groene zone voor items die toebehoren tot de categorie <font color="#0000ff">leftAttribute</font>.<br/>',
						'Zet je rechtervinger op de <b>rechter</b> groene zone voor items voor items die toebehoren tot de categorie <font color="#0000ff">rightAttribute</font>.<br/>',
						'De items zullen één voor één verschijnen.<br/>',
						'<br/>',
						'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. Corrigeer je fout door de andere toets in te tikken. <u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.',
					'</p>',
					'<p align="center">Klik de <b>onderste </b> groene regio aan om te starten.</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Zet je linkervinger op de <b>E</b> toets voor items die toebehoren tot de categorie <font color="#336600">leftCategory</font>.' +
				'<br/>Zet je je rechtervinger op de <b>I</b> toets voor items die toebehoren tot de categorie <font color="#336600">rightCategory</font>.<br/>' +
				'De items zullen één voor één verschijnen.<br/><br/>' +
				'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. ' +
				'Corrigeer je fout door de andere toets in te tikken.<br/>' +
				'<u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/><br/></p>'+
				'<p align="center">Druk op de <b>spatie toets</b> wanneer je klaar bent om te starten.</font></p></div>',
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Zet je linkervinger op de <b>linker</b> groene zone voor items die toebehoren tot de categorie <font color="#336600">leftCategory</font>.<br/>',
						'Zet je rechtervinger op de <b>rechter</b> groene zone voor items voor items die toebehoren tot de categorie <font color="#336600">rightCategory</font>.<br/>',
						'De items zullen één voor één verschijnen.<br/>',
						'<br/>',
						'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. Corrigeer je fout door de andere toets in te tikken. <u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.',
					'</p>',
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Elke item hoort toe aan één categorie.<br/><br/>' +
				'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen.  ' +
				'Corrigeer je fout door de andere toets in te tikken.<br/>' + 
				'<u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/><br/></p>' +
				'<p align="center">Druk op de <b>spatie toets</b> wanneer je klaar bent om te starten.</font></p></div>',
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Zet je linkervinger op de <b>linker</b> groene zone voor items die toebehoren tot de categorie <font color="#336600">leftCategory</font> of  <font color="#0000ff">leftAttribute</font>.</br>',
						'Zet je rechtervinger op de <b>rechter</b> groene zone voor items voor items die toebehoren tot de categorie <font color="#336600">rightCategory</font> of <font color="#0000ff">rightAttribute</font>.</br>',
							'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. Corrigeer je fout door de andere toets in te tikken. <u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.</br>',
						'</p>',
						'<p align="center"> Klik de <b>onderste </b> groene regio aan om te starten.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Dit is hetzelfde als het voorgaande.<br/>' +
				'Gebruik de <b>E</b> toets voor  <font color="#336600">leftCategory</font> of <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Gebruik de <b>I</b> toets voor <font color="#336600">rightCategory</font> of  <font color="#0000ff">rightAttribute</font>.<br/>' +
				'Elke item hoort toe aan één categorie.<br/><br/>' +
				'<u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/><br/></p>' +
				'<p align="center">Druk op de <b>spatie toets</b> wanneer je klaar bent om te starten.</font></p></div>',
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Zet je rechtervinger op de <b>rechter</b> groene zone voor items voor items die toebehoren tot de categorie <font color="#336600">rightCategory</font> of <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/>',
					'</p>',
					'<p align="center">Klik de <b>onderste </b> groene regio aan om te starten.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b>Let op, de labels zijn van plaats veranderd!</b><br/>' +
				'Gebruik je linkervinger op de <b>E</b> toets voor  <font color="#336600">leftCategory</font>.<br/>' +
				'Gebruik je rechtervinger op de  <b>I</b> toets voor <font color="#336600">rightCategory</font>.<br/><br/>' +
				'<u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/><br/></p>' +
				'<p align="center">Druk op de <b>spatie toets</b> wanneer je klaar bent om te starten.</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Let op, de labels zijn van plaats veranderd!<br/>',
							'Zet je linkervinger op de <b>linker</b> groene zone voor items die toebehoren tot de categorie <font color="#336600">leftCategory</font> items.<br/>',
							'Zet je rechtervinger op de <b>rechter</b> groene zone voor items voor items die toebehoren tot de categorie <font color="#336600">rightCategory</font> items.<br/>',
							'De items zullen één voor één verschijnen.',
							'<br/>',
							'Als je een fout maakt, zal er een rode <font color="#ff0000"><b>X</b></font> verschijnen. Corrigeer je fout door de andere toets in te tikken. <u>Ga zo snel als je kan</u> en probeer zo min mogelijk fouten te maken.<br/>',
						'</p>',
						'<p align="center">Klik de <b>onderste </b> groene regio aan om te starten.</p>',
